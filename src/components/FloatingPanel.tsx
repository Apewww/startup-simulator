...
export function FloatingPanel({ id, title, icon, children, accent = '#7C3AED', index = 0 }: FloatingPanelProps) {
  ...
  return (
    <div
      ...
      className={`absolute glass-card rounded-2xl overflow-hidden panel-anim transition-[box-shadow] duration-200 pointer-events-auto
    ...
    >
      <div
        ...
        className="flex items-center justify-between px-4 py-2.5 border-b cursor-grab active:cursor-grabbing select-none"
      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button onClick={() => toggleMinimize(id)} className="p-1.5 rounded-lg hover:bg-white/10 text-gray-300 cursor-pointer" title="Minimize">
