...
import { Users, LayoutGrid, Server, DollarSign, UserCheck, Gift, Target, Landmark, BarChart3, Megaphone, Microscope, Handshake, Wallet, TrendingUp, Briefcase, Bug } from 'lucide-react';
...
export const DOCK_ITEMS: { id: PanelId; label: string; shortcut: string; Icon: typeof Users; accent: string }[] = [
  ...
  { id: 'stockmarket', label: 'Stocks', shortcut: '', Icon: TrendingUp, accent: '#17A366' },
