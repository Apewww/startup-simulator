...
export const NODE_DEFS: NodeDef[] = [
  ...
  },
  {
    ...
    price: 900,
    monthlyCost: 100,
    compute: 12, data: 0, network: 0, security: 0,
    description: 'Web server kelas hyperscale untuk traffic masif.',
  },
  {
    typeId: 'db_t1',
    label: 'Database T1',
  ...
  },
  {
    ...
    price: 700,
    monthlyCost: 90,
    compute: 0, data: 8, network: 0, security: 0,
    description: 'Database cluster kelas enterprise untuk data masif.',
  },
  {
    typeId: 'cache_t1',
    label: 'Caching T1',
  ...
  },
  {
    ...
    price: 400,
    monthlyCost: 40,
    compute: 0, data: 0, network: 10, security: 0,
  ...
  },
  {
    ...
    description: 'Kipas pendingin menambah cooling capacity +15.',
  },
  {
    ...
    monthlyCost: 15,
    compute: 0, data: 0, network: 0, security: 0,
    description: 'Pendingin industri menambah cooling capacity +40 (dan +10 ke rack tetangga di grid).',
  },
  {
    ...
    monthlyCost: 30,
    compute: 0, data: 0, network: 0, security: 0,
    description: 'Pendingin cair performa tinggi +90 cooling.',
  },
  {
    typeId: 'storage',
    label: 'Storage',
